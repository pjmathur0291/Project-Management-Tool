            ...
            if (!$can_modify) {
                ...
                switch ($_POST['action']) {
                    ...
                    case 'hold':
                        ...
                        if ($stmt->execute([$task_id])) {
                            $success_message = 'Task put on hold!';
                        } else {
...
<head>
    ...
    <style>
        ...
        .role-badge.employee { background: #28a745; }
    </style>
</head>
<body>
    <div class="task-management-container">
        ...
        <?php if (empty($tasks)): ?>
            <div class="no-tasks">
                ...
                <?php else: ?>
                    <p>You have no tasks assigned to you in the "<?php echo ucfirst(str_replace('_', ' ', $current_tab)); ?>" category.</p>
                    <p>Contact your manager or administrator to get tasks assigned.</p>
                <?php endif; ?>
            </div>
        <?php else: ?>
